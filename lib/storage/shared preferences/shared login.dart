...
import 'package:flutter_sep23/storage/shared%20preferences/Shared%20signup.dart';
import 'package:flutter_sep23/storage/shared%20preferences/shared%20home.dart';
...
class _SharedLoginState extends State<SharedLogin> {
  ...
  void check_user_loggedin() async {
    ...
    loggedin = preferences.getBool("loggedin") ?? false;//2logged in seperate annu "logged in "shared preferenceil ullathu annu
    if (loggedin == true) {
